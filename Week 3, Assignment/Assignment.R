# makeCacheMatrix function with argument x creates object x. This then create space for x and i to store the values. 
# It sets, gets, calculates inverse and sets the value of inverse in parent environment. Subsequently it stores all 
# the values in a list. 
# cacheSolve function accepts the value, and check if the variable holding cached value i.e.if i is empty. It then 
...
# there is no value, it begins calculating the value of inverse of input value. It then returns the values
# to to respective functions in makecacheMatrix environment.
